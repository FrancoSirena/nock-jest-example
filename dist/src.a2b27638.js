...
},{"./lib/axios":"node_modules/axios/lib/axios.js"}],"src/component.js":[function(require,module,exports) {
...
module.exports = function () {
  ...
  div.innerHTML = "I am trying";
  document.body.appendChild(div);
  request("https://api.mocki.io/v1/1767b67d").then(function (_ref) {
    var data = _ref.data;
    ...
    try {
      for (_iterator.s(); !(_step = _iterator.n()).done;) {
        ...
        li.innerHTML = "Band: ".concat(item.band, " Genre ").concat(item.genre);
        bands.append(li);
      }
    } catch (err) {
      _iterator.e(err);
  ...
  request("https://api.mocki.io/v1/1db31e8e").then(function (_ref2) {
    var data = _ref2.data;
    ...
    try {
      for (_iterator2.s(); !(_step2 = _iterator2.n()).done;) {
        ...
        var li = document.createElement("li");
        li.innerHTML = "Song: ".concat(item.song, " Band ").concat(item.band);
        songs.append(li);
      }
    } catch (err) {
      _iterator2.e(err);
...
},{"./component":"src/component.js"}],"node_modules/parcel/src/builtins/hmr-runtime.js":[function(require,module,exports) {
